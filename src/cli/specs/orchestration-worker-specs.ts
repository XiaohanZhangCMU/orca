...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    notes: [
      ...
      '--model supports Claude, Codex, Cursor, OpenCode, and Antigravity opaque provider model ids; --effort requires --model. Neither can combine with --terminal.',
      'OpenCode models use provider/model ids configured on the execution host; OpenCode does not support --effort.',
